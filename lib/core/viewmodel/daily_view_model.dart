...
import 'package:eyepetizer/core/services/daily_request.dart';
import 'package:eyepetizer/core/viewmodel/base_view_model.dart';


class ZCLDailyViewModel extends ZCLBaseViewModel {
  ...
  Future<void> update() async {
    await ZCLDailyRequest.getData().then<ZCLCardPageModel>((x) {
      cardPageModel = x;
